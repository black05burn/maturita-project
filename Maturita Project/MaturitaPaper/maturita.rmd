...
Project is aimed at programming in C\# language in game engine Unity. 
Visual studio is used to edit scripts. Krita is used to make images for the UI. Everything else is done in Unity Editor, where every level and animation of characters is made.
